...
public class SmartConnectionService
{
    ...
    public async Task<string?> CorrectSentenceAsync(string sentence, List<WordCorrectionDto>? corrections)
    {
    ...
    private static string BuildPrompt(List<WordCorrectionDto>? corrections)
    {
...
public record WordCorrectionDto(string Original, string Corrected);
